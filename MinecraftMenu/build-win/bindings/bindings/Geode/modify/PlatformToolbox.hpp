...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlatformToolbox> : ModifyBase<ModifyDerive<Der, PlatformToolbox>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlatformToolbox, loadAndDecryptFileToString, , char const*, char const*, gd::string&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PlatformToolbox, toggleFullScreen, , bool, bool, bool)
