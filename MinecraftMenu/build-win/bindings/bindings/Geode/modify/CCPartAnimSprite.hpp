...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCPartAnimSprite> : ModifyBase<ModifyDerive<Der, CCPartAnimSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCPartAnimSprite, setScaleX, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCPartAnimSprite, setScaleY, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCPartAnimSprite, setScale, , float)
