...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TextGameObject> : ModifyBase<ModifyDerive<Der, TextGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TextGameObject, customObjectSetup, , gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TextGameObject, getSaveString, , GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TextGameObject, updateTextKerning, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TextGameObject, getTextKerning, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TextGameObject, init, , cocos2d::CCTexture2D*)
