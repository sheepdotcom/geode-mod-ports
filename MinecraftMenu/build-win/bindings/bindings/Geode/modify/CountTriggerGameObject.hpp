...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CountTriggerGameObject> : ModifyBase<ModifyDerive<Der, CountTriggerGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CountTriggerGameObject, create, , char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CountTriggerGameObject, customObjectSetup, , gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CountTriggerGameObject, getSaveString, , GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CountTriggerGameObject, init, , char const*)
		}
	};
}
