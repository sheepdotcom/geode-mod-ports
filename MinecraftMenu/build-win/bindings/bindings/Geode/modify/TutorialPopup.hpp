...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialPopup> : ModifyBase<ModifyDerive<Der, TutorialPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, create, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, animateMenu, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, closeTutorial, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, init, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialPopup, registerForCallback, , cocos2d::SEL_MenuHandler, cocos2d::CCNode*)
		}
	};
}
