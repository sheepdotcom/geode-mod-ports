...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NewgroundsInfoLayer> : ModifyBase<ModifyDerive<Der, NewgroundsInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xc5690, Thiscall, NewgroundsInfoLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onArtists, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onChanges, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onGuidelines, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onInfo, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onNewgrounds, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NewgroundsInfoLayer, onSupporter, , cocos2d::CCObject*)
		}
	};
}
