...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJFollowCommandLayer> : ModifyBase<ModifyDerive<Der, GJFollowCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, onClose, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, onUpdateGroupID, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, onUpdateGroupID2, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, sliderXModChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, sliderYModChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateDurLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateTargetGroupID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateTargetGroupID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateTextInputLabel2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateXMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateXModLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateYMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJFollowCommandLayer, updateYModLabel, )
		}
	};
}
