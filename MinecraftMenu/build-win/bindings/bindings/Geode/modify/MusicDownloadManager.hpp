...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MusicDownloadManager> : ModifyBase<ModifyDerive<Der, MusicDownloadManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MusicDownloadManager, downloadSongFailed, , int, GJSongError)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MusicDownloadManager, removeDLFromActive, , char const*)
