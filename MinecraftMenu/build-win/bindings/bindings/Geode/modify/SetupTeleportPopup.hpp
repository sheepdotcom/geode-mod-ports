...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTeleportPopup> : ModifyBase<ModifyDerive<Der, SetupTeleportPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, create, , TeleportPortalObject*, cocos2d::CCArray*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, init, , TeleportPortalObject*, cocos2d::CCArray*, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, onTeleportGravity, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupTeleportPopup, updateTeleportGravityState, , int)
		}
	};
}
