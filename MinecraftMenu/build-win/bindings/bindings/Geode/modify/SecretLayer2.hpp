...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer2> : ModifyBase<ModifyDerive<Der, SecretLayer2>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, create, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, onExit, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, textChanged, , CCTextInputNode*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, nodeWithTag, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, playCoinEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer2, selectAThread, )
