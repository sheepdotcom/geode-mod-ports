...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupStopTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupStopTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStopTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStopTriggerPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStopTriggerPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStopTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
