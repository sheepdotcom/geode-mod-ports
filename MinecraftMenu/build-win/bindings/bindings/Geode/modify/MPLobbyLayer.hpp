...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MPLobbyLayer> : ModifyBase<ModifyDerive<Der, MPLobbyLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, create, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, scene, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, keyDown, , cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, joinLobbyFinished, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, joinLobbyFailed, , int, GJMPErrorCode)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, updateComments, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, didUploadMPComment, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, textInputOpened, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, textInputClosed, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, textChanged, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, keyUp, , cocos2d::enumKeyCodes)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, FLAlert_Clicked, , FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, uploadActionFinished, , int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, uploadActionFailed, , int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onClosePopup, , UploadActionPopup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, init, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onBtn1, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onBtn2, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onBtn3, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onComment, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, onUpdateLobby, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, postComment, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, tryExitLobby, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MPLobbyLayer, updateLobby, , float)
		}
	};
}
