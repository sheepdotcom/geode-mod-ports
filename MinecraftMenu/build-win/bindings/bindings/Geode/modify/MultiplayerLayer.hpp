...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MultiplayerLayer> : ModifyBase<ModifyDerive<Der, MultiplayerLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, onBtn1, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MultiplayerLayer, onBtn2, , cocos2d::CCObject*)
		}
	};
}
