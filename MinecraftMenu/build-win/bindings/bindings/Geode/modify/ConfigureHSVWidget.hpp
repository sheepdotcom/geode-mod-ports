...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ConfigureHSVWidget> : ModifyBase<ModifyDerive<Der, ConfigureHSVWidget>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ConfigureHSVWidget, onClose, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x97b10, Thiscall, ConfigureHSVWidget, onResetHSV, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ConfigureHSVWidget, onToggleSConst, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ConfigureHSVWidget, onToggleVConst, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ConfigureHSVWidget, sliderChanged, , cocos2d::CCObject*)
