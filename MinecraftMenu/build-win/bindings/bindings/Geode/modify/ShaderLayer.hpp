...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShaderLayer> : ModifyBase<ModifyDerive<Der, ShaderLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4697b0, Thiscall, ShaderLayer, update, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShaderLayer, prepareTargetContainer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShaderLayer, prePinchShader, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShaderLayer, prePixelateShader, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShaderLayer, updateEffectOffsets, , cocos2d::CCPoint)
