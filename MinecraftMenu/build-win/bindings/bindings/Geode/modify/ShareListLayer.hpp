...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareListLayer> : ModifyBase<ModifyDerive<Der, ShareListLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f50d0, Thiscall, ShareListLayer, init, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, onClose, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShareListLayer, updateUnlistedF, )
		}
	};
}
