...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelPage> : ModifyBase<ModifyDerive<Der, LevelPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelPage, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelPage, playStep2, )
