...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupMGTrigger> : ModifyBase<ModifyDerive<Der, SetupMGTrigger>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x410830, Thiscall, SetupMGTrigger, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, valuePopupClosed, , ConfigureValuePopup*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, onEasing, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, onEasingRate, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, posFromSliderValue, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, sliderValueFromPos, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, sliderYChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, toggleEasingRateVisibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateDurLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateEasingRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateMoveCommandEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateMoveCommandEasingRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateMoveCommandPosY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupMGTrigger, updateValueYLabel, )
		}
	};
}
