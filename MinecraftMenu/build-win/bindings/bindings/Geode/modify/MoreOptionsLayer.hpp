...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MoreOptionsLayer> : ModifyBase<ModifyDerive<Der, MoreOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, textInputShouldOffset, , CCTextInputNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, textInputReturn, , CCTextInputNode*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, countForPage, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, layerForPage, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, objectsForPage, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, onInfo, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xdba40, Thiscall, MoreOptionsLayer, onKeybindings, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, onNextPage, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, onParental, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MoreOptionsLayer, onPrevPage, , cocos2d::CCObject*)
