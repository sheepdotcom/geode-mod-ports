...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomizeObjectSettingsPopup> : ModifyBase<ModifyDerive<Der, CustomizeObjectSettingsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomizeObjectSettingsPopup, create, , GameObject*, cocos2d::CCArray*, CustomizeObjectLayer*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CustomizeObjectSettingsPopup, init, , GameObject*, cocos2d::CCArray*, CustomizeObjectLayer*)
		}
	};
}
