...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupSequenceTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupSequenceTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, create, , SequenceTriggerGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, init, , SequenceTriggerGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, onAddChance, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, onChangeOrder, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, onDeleteSelected, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, onSelect, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupSequenceTriggerPopup, updateGroupIDButtons, )
		}
	};
}
