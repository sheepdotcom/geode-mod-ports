...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJShopLayer> : ModifyBase<ModifyDerive<Der, GJShopLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJShopLayer, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJShopLayer, registerWithTouchDispatcher, )
