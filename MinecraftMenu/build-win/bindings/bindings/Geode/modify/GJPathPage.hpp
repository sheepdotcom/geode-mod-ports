...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathPage> : ModifyBase<ModifyDerive<Der, GJPathPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x281710, Thiscall, GJPathPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27fb40, Thiscall, GJPathPage, didPurchaseItem, GJStoreItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, init, , int, GJPathsLayer*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, onUnlock, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x280400, Thiscall, GJPathPage, playUnlockAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, showCantAffordMessage, , GJStoreItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathPage, unlockAnimationFinished, )
