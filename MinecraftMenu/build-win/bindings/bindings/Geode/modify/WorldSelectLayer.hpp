...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, WorldSelectLayer> : ModifyBase<ModifyDerive<Der, WorldSelectLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, create, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, scene, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, scrollLayerWillScrollToPage, , BoomScrollLayer*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, scrollLayerScrolledToPage, , BoomScrollLayer*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, scrollLayerMoved, , cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, animateInActiveIsland, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, colorForPage, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, getColorValue, , int, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, goToPage, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, init, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, onFreeLevels, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, onGarage, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, onNext, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, onPrev, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, setupWorlds, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, showCompleteDialog, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, tryShowAd, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, unblockButtons, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldSelectLayer, updateArrows, )
		}
	};
}
