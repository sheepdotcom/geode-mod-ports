...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountManager> : ModifyBase<ModifyDerive<Der, GJAccountManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJAccountManager, onGetAccountSyncURLCompleted, , gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fbee0, Thiscall, GJAccountManager, onLoginAccountCompleted, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJAccountManager, onProcessHttpRequestCompleted, , cocos2d::extension::CCHttpClient*, cocos2d::extension::CCHttpResponse*)
