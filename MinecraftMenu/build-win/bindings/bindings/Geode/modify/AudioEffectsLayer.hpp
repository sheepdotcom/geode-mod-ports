...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AudioEffectsLayer> : ModifyBase<ModifyDerive<Der, AudioEffectsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, create, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(AudioEffectsLayer, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, updateTweenAction, , float, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x84d80, Thiscall, AudioEffectsLayer, audioStep, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, getBGSquare, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, goingDown, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, init, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, resetAudioVars, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AudioEffectsLayer, triggerEffect, , float)
		}
	};
}
