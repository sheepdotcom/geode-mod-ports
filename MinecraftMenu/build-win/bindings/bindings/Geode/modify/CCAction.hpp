...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCAction> : ModifyBase<ModifyDerive<Der, cocos2d::CCAction>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCAction@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCAction, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCAction@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCAction)
