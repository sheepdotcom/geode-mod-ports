...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupShakePopup> : ModifyBase<ModifyDerive<Der, SetupShakePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x43dd60, Thiscall, SetupShakePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, updateDurLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, updateInterval, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, updateIntervalLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, updateShake, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShakePopup, updateShakeLabel, , bool)
		}
	};
}
