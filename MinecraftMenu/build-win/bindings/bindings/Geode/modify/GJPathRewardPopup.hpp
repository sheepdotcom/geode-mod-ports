...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathRewardPopup> : ModifyBase<ModifyDerive<Der, GJPathRewardPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathRewardPopup, create, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJPathRewardPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathRewardPopup, closePopup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2825f0, Thiscall, GJPathRewardPopup, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathRewardPopup, onClaim, , cocos2d::CCObject*)
		}
	};
}
