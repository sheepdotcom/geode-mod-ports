...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorPauseLayer> : ModifyBase<ModifyDerive<Der, EditorPauseLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d2b80, Thiscall, EditorPauseLayer, doResetUnused, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xdb7d0, Thiscall, EditorPauseLayer, onBuildHelper, cocos2d::CCObject*)
