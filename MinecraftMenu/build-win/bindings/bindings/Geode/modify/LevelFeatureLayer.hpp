...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelFeatureLayer> : ModifyBase<ModifyDerive<Der, LevelFeatureLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, create, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, init, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onDown, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onDown2, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onRemoveValues, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onSetEpicOnly, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onSetFeatured, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onToggleEpic, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onUp, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, onUp2, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelFeatureLayer, updateStars, )
		}
	};
}
