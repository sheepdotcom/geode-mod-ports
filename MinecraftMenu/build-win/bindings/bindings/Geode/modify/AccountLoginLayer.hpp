...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountLoginLayer> : ModifyBase<ModifyDerive<Der, AccountLoginLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, registerWithTouchDispatcher, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, createTextBackground, , cocos2d::CCPoint, char const*, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, createTextInput, , cocos2d::CCPoint, cocos2d::CCSize, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, createTextLabel, , cocos2d::CCPoint, char const*, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, disableNodes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, hideLoadingUI, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x7b8d0, Thiscall, AccountLoginLayer, init, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, onClose, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, resetLabel, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, resetLabels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, showLoadingUI, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, toggleUI, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountLoginLayer, updateLabel, , AccountError)
		}
	};
}
