...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretGame01Layer> : ModifyBase<ModifyDerive<Der, SecretGame01Layer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, update, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, didSelectCorrectObject, , CCMenuItemSpriteExtra*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, gameStep01, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, gameStep02, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, getCountForDifficulty, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, getFrameForDifficulty, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, getRowsForDifficulty, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, getTimeForDifficulty, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, onSelectButton, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, resetGame, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, resetGameTimer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, scaleOutGame, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, showGameOver, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretGame01Layer, showGameWon, )
		}
	};
}
