...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CreateGuidelinesLayer> : ModifyBase<ModifyDerive<Der, CreateGuidelinesLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, create, , CustomSongDelegate*, AudioGuidelinesType)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, registerWithTouchDispatcher, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, doClearGuidelines, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, getMergedRecordString, , gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, init, , CustomSongDelegate*, AudioGuidelinesType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, onClearGuidelines, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, onStop, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CreateGuidelinesLayer, toggleItems, , bool)
		}
	};
}
