...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObject> : ModifyBase<ModifyDerive<Der, GameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, update, , float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, firstSetup, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, triggerObject, , GJBaseGameLayer*, int, gd::vector<int> const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, customObjectSetup, , gd::vector<gd::string>&, gd::vector<void*>&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, particleWasActivated, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, triggerActivated, , float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, animationTriggered, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19dec0, Thiscall, GameObject, selectObject, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, activatedByPlayer, , PlayerObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, hasBeenActivatedByPlayer, , PlayerObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, hasBeenActivated, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canAllowMultiActivate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, blendModeChanged, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateMainParticleOpacity, , unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateSecondaryParticleOpacity, , unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canReverse, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isSpecialSpawnObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canBeOrdered, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getObjectLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setObjectLabel, , cocos2d::CCLabelBMFont*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, shouldDrawEditorHitbox, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getHasSyncedAnimation, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getHasRotateAction, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, canMultiActivate, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, updateTextKerning, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getTextKerning, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getType, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, setType, , GameObjectType)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, addGlow, , gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, getRelativeSpriteColor, , int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, init, , char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isSpawnableTrigger, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameObject, isTrigger, )
