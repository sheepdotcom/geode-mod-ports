...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretNumberLayer> : ModifyBase<ModifyDerive<Der, SecretNumberLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretNumberLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretNumberLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretNumberLayer, playNumberEffect, , int)
		}
	};
}
