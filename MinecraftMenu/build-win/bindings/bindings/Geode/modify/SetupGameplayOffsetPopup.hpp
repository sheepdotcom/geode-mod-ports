...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupGameplayOffsetPopup> : ModifyBase<ModifyDerive<Der, SetupGameplayOffsetPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, updateInputValue, , int, float&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, updateInputNode, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, triggerValueFromSliderValue, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, triggerSliderValueFromValue, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGameplayOffsetPopup, onDefaultValues, , cocos2d::CCObject*)
		}
	};
}
