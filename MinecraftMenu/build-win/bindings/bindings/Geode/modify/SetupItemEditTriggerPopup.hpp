...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupItemEditTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupItemEditTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemEditTriggerPopup, create, , ItemTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemEditTriggerPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemEditTriggerPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemEditTriggerPopup, onOpButton, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x453eb0, Thiscall, SetupItemEditTriggerPopup, updateFormulaLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemEditTriggerPopup, updateOpButton, , CCMenuItemSpriteExtra*, int, int)
		}
	};
}
