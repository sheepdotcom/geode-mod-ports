...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCParticleSystemQuad> : ModifyBase<ModifyDerive<Der, cocos2d::CCParticleSystemQuad>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCParticleSystemQuad@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCParticleSystemQuad)
