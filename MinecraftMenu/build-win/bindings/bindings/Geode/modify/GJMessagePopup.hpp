...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMessagePopup> : ModifyBase<ModifyDerive<Der, GJMessagePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, create, , GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, keyBackClicked, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, blockUser, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, init, , GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x290760, Thiscall, GJMessagePopup, loadFromGJMessage, GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, onBlock, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, onRemove, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJMessagePopup, onReply, , cocos2d::CCObject*)
		}
	};
}
