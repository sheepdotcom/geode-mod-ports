...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DialogLayer> : ModifyBase<ModifyDerive<Der, DialogLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, onEnter, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, registerWithTouchDispatcher, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, animateIn, , DialogAnimationType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, animateInDialog, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DialogLayer, finishCurrentAnimation, )
