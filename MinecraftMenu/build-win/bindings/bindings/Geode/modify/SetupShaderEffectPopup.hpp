...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupShaderEffectPopup> : ModifyBase<ModifyDerive<Der, SetupShaderEffectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, create, , EffectGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, toggleGroup, , int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, init, , EffectGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, onResetColors, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, onZLayer, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupBulge, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupChromatic, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupChromaticGlitch, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupColorChange, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupGlitch, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupGrayscale, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupHueShift, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupInvertColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupLensCircle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupMotionBlur, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupPinch, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupPixelate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupRadialBlur, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupSepia, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupShaderTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupShockLine, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupShockWave, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, setupSplitScreen, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, updateZLayerButtons, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupShaderEffectPopup, zLayerToString, , int)
		}
	};
}
