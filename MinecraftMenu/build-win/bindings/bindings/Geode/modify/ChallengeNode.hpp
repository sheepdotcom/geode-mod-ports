...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ChallengeNode> : ModifyBase<ModifyDerive<Der, ChallengeNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ChallengeNode, onClaimReward, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ChallengeNode, updateTimeLabel, , gd::string)
		}
	};
}
