...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPromoPopup> : ModifyBase<ModifyDerive<Der, GJPromoPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPromoPopup, create, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d890, Thiscall, GJPromoPopup, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPromoPopup, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPromoPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPromoPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29d590, Thiscall, GJPromoPopup, init, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPromoPopup, onClose, , cocos2d::CCObject*)
		}
	};
}
