...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EndLevelLayer> : ModifyBase<ModifyDerive<Der, EndLevelLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EndLevelLayer, create, , PlayLayer*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EndLevelLayer, currencyEnterFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EndLevelLayer, diamondEnterFinished, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EndLevelLayer, init, , PlayLayer*)
