...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEnterEffectPopup> : ModifyBase<ModifyDerive<Der, SetupEnterEffectPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, create, , EnterEffectObject*, cocos2d::CCArray*, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, updateInputValue, , int, float&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, updateInputNode, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x408750, Thiscall, SetupEnterEffectPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, triggerValueFromSliderValue, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, triggerSliderValueFromValue, , int, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, init, , EnterEffectObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, onEnterType, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, onHSV, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, onNextFreeEnterChannel, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, onNextFreeEnterEffectID, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupEnterEffectPopup, updateHSVButton, )
		}
	};
}
