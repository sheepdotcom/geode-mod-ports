...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupGravityModPopup> : ModifyBase<ModifyDerive<Der, SetupGravityModPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, create, , EffectGameObject*, cocos2d::CCArray*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, textInputClosed, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, textChanged, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, init, , EffectGameObject*, cocos2d::CCArray*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, onItemIDArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, updateItemID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, updateTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, updateValue, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityModPopup, updateValueLabel, )
		}
	};
}
