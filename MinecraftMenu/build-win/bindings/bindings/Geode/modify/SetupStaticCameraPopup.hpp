...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupStaticCameraPopup> : ModifyBase<ModifyDerive<Der, SetupStaticCameraPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStaticCameraPopup, create, , CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStaticCameraPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStaticCameraPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStaticCameraPopup, init, , CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupStaticCameraPopup, updateState, )
		}
	};
}
