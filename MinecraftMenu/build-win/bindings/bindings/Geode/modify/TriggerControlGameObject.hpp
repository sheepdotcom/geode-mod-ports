...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TriggerControlGameObject> : ModifyBase<ModifyDerive<Der, TriggerControlGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TriggerControlGameObject, create, , char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TriggerControlGameObject, triggerObject, , GJBaseGameLayer*, int, gd::vector<int> const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TriggerControlGameObject, customObjectSetup, , gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TriggerControlGameObject, getSaveString, , GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TriggerControlGameObject, init, , char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TriggerControlGameObject, updateTriggerControlFrame, )
		}
	};
}
