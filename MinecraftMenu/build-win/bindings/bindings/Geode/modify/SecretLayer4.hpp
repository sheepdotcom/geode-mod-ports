...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer4> : ModifyBase<ModifyDerive<Der, SecretLayer4>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d87b0, Thiscall, SecretLayer4, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3dc3b0, Thiscall, SecretLayer4, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, textInputOpened, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, textInputClosed, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, textChanged, , CCTextInputNode*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, getBasicMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, getErrorMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, getMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, getThreadMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, nodeWithTag, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, onChest01, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, onSubmit, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, playCoinEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, selectAThread, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, showDialog, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, showFirstDialog, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, updateMessageLabel, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer4, updateSearchLabel, , char const*)
		}
	};
}
