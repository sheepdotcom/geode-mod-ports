...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCountPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCountPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, onClose, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, onCountType, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, onEnableGroup, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, onTargetCountArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, onTargetID2Arrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4045c0, Thiscall, SetupInstantCountPopup, onTargetIDArrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateCountTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401fd0, Thiscall, SetupInstantCountPopup, updateItemID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateItemIDInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateTargetCount, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCountPopup, updateTargetIDInputLabel, )
		}
	};
}
