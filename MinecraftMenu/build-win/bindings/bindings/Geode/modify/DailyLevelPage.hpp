...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, DailyLevelPage> : ModifyBase<ModifyDerive<Der, DailyLevelPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, keyBackClicked, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, createNodeIfLoaded, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, downloadAndCreateNode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, exitDailyNode, , DailyLevelNode*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, getDailyTime, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, refreshDailyPage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(DailyLevelPage, skipDailyLevel, , DailyLevelNode*, GJGameLevel*)
