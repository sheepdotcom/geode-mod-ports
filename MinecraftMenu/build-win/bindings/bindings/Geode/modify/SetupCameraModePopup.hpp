...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraModePopup> : ModifyBase<ModifyDerive<Der, SetupCameraModePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, onEditCameraSettings, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, onUnboundMode, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, updateCameraEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, updateCameraEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, updateCameraPadding, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, updateCameraPaddingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraModePopup, updateItemVisibility, )
		}
	};
}
