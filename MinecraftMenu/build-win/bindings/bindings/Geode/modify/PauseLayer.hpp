...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PauseLayer> : ModifyBase<ModifyDerive<Der, PauseLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3687e0, Thiscall, PauseLayer, onEdit, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(PauseLayer, onTryEdit, , cocos2d::CCObject*)
