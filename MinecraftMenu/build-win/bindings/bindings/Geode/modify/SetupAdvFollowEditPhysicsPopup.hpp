...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAdvFollowEditPhysicsPopup> : ModifyBase<ModifyDerive<Der, SetupAdvFollowEditPhysicsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAdvFollowEditPhysicsPopup, create, , AdvancedFollowEditObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAdvFollowEditPhysicsPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAdvFollowEditPhysicsPopup, init, , AdvancedFollowEditObject*, cocos2d::CCArray*)
		}
	};
}
