...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SupportLayer> : ModifyBase<ModifyDerive<Der, SupportLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, customSetup, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, createToggleButton, , gd::string, cocos2d::SEL_MenuHandler, bool, cocos2d::CCMenu*, cocos2d::CCPoint, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, exitLayer, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onCocos2d, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onEmail, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onGetReward, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onLinks, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b1180, Thiscall, SupportLayer, onLowDetail, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onPrivacy, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b0d30, Thiscall, SupportLayer, onRequestAccess, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onRobTop, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onSFX, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, onTOS, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SupportLayer, sendSupportMail, )
		}
	};
}
