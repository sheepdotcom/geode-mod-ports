...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJPathsLayer> : ModifyBase<ModifyDerive<Der, GJPathsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27dac0, Thiscall, GJPathsLayer, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathsLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27db20, Thiscall, GJPathsLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathsLayer, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathsLayer, darkenButtons, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27dac0, Thiscall, GJPathsLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJPathsLayer, onPath, , cocos2d::CCObject*)
		}
	};
}
