...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupGravityTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupGravityTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityTriggerPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupGravityTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
		}
	};
}
