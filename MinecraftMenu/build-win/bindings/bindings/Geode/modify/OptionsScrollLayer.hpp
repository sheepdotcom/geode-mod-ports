...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, OptionsScrollLayer> : ModifyBase<ModifyDerive<Der, OptionsScrollLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, create, , cocos2d::CCArray*, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x326150, Thiscall, OptionsScrollLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, cellPerformedAction, , TableViewCell*, int, CellAction, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, getRelevantObjects, , cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, init, , cocos2d::CCArray*, bool, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(OptionsScrollLayer, setupList, , cocos2d::CCArray*)
		}
	};
}
