...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCEGLViewProtocol> : ModifyBase<ModifyDerive<Der, cocos2d::CCEGLViewProtocol>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCEGLViewProtocol@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCEGLViewProtocol, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCEGLViewProtocol@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCEGLViewProtocol)
