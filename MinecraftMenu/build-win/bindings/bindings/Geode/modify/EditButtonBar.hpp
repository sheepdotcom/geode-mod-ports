...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditButtonBar> : ModifyBase<ModifyDerive<Der, EditButtonBar>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditButtonBar, getPage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditButtonBar, goToPage, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(EditButtonBar, init, , cocos2d::CCArray*, cocos2d::CCPoint, int, bool, int, int)
