...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJBigSprite> : ModifyBase<ModifyDerive<Der, GJBigSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, finishedLoadingSpriteAsync, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, loadSpriteAsync, , gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, unloadAll, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, unloadSprite, , gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJBigSprite, updateSpriteVisibility, )
		}
	};
}
