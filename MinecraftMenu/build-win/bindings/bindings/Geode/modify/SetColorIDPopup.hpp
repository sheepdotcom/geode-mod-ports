...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetColorIDPopup> : ModifyBase<ModifyDerive<Der, SetColorIDPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetColorIDPopup, create, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x294cf0, Thiscall, SetColorIDPopup, colorSelectClosed, GJSpecialColorSelect*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetColorIDPopup, init, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetColorIDPopup, onSelectSpecialColor, , cocos2d::CCObject*)
		}
	};
}
