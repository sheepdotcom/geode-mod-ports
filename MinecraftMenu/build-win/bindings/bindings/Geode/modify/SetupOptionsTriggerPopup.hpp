...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupOptionsTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupOptionsTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOptionsTriggerPopup, create, , GameOptionsTrigger*, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOptionsTriggerPopup, addOption, , int, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupOptionsTriggerPopup, init, , GameOptionsTrigger*, cocos2d::CCArray*)
		}
	};
}
