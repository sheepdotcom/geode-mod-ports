...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NCSInfoLayer> : ModifyBase<ModifyDerive<Der, NCSInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, create, , CustomSongLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, init, , CustomSongLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, onLibrary, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, onNCS, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, onNCSIO, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(NCSInfoLayer, onNCSUsage, , cocos2d::CCObject*)
		}
	};
}
