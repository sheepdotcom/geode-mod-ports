...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCollisionTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupCollisionTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x401ac0, Thiscall, SetupCollisionTriggerPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onActivateOnExit, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onEnableGroup, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onItemID2Arrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onItemIDArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onTargetIDArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onTargetP1, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onTargetP2, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, onTargetPP, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, updateItemID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, updateItemID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, updateItemID2InputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, updateItemIDInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCollisionTriggerPopup, updateTargetIDInputLabel, )
		}
	};
}
