...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UIPOptionsLayer> : ModifyBase<ModifyDerive<Der, UIPOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x29e170, Thiscall, UIPOptionsLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, ccTouchBegan, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, ccTouchMoved, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, ccTouchEnded, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, getValue, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, getTouchRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIPOptionsLayer, onReset, , cocos2d::CCObject*)
		}
	};
}
