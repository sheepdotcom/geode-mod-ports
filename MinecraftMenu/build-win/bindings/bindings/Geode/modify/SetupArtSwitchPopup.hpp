...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupArtSwitchPopup> : ModifyBase<ModifyDerive<Der, SetupArtSwitchPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupArtSwitchPopup, create, , ArtTriggerGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x459ed0, Thiscall, SetupArtSwitchPopup, selectArtClosed, SelectArtLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupArtSwitchPopup, init, , ArtTriggerGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupArtSwitchPopup, onArt, , cocos2d::CCObject*)
		}
	};
}
