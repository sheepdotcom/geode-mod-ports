...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRotateCommandPopup> : ModifyBase<ModifyDerive<Der, SetupRotateCommandPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, updateInputNode, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, triggerValueFromSliderValue, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, triggerSliderValueFromValue, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a06d0, Thiscall, SetupRotateCommandPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRotateCommandPopup, onInfiniteDuration, , cocos2d::CCObject*)
