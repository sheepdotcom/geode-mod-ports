...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer5> : ModifyBase<ModifyDerive<Der, SecretLayer5>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2c02c0, Default, SecretLayer5, scene, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer5, fadeInMessage, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer5, incrementChatIdx, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer5, showDialog, , int)
