...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectSFXSortLayer> : ModifyBase<ModifyDerive<Der, SelectSFXSortLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectSFXSortLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x468b50, Thiscall, SelectSFXSortLayer, init, AudioSortType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectSFXSortLayer, onClose, , cocos2d::CCObject*)
