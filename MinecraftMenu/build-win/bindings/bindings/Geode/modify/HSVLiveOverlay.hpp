...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, HSVLiveOverlay> : ModifyBase<ModifyDerive<Der, HSVLiveOverlay>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(HSVLiveOverlay, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b2c00, Thiscall, HSVLiveOverlay, hsvChanged, ConfigureHSVWidget*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(HSVLiveOverlay, closeColorSelect, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(HSVLiveOverlay, toggleControls, , bool)
		}
	};
}
