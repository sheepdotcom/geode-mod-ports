...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraEdgePopup> : ModifyBase<ModifyDerive<Der, SetupCameraEdgePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, create, , CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3fbfc0, Thiscall, SetupCameraEdgePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, init, , CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, onCameraEdge, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, onTargetIDArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, onUnlockEdge, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraEdgePopup, updateTextInputLabel, )
		}
	};
}
