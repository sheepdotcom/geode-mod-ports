...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSongBrowser> : ModifyBase<ModifyDerive<Der, GJSongBrowser>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, exitLayer, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b0470, Thiscall, GJSongBrowser, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, cellPerformedAction, , TableViewCell*, int, CellAction, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, getSelectedCellIdx, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2b00b0, Thiscall, GJSongBrowser, loadPage, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, onDeleteAll, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, setupPageInfo, , int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJSongBrowser, setupSongBrowser, , cocos2d::CCArray*)
		}
	};
}
