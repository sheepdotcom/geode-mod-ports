...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelLeaderboard> : ModifyBase<ModifyDerive<Der, LevelLeaderboard>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, keyBackClicked, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, deleteLocalScores, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, getLocalScores, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, getSpriteButton, , gd::string, cocos2d::SEL_MenuHandler, cocos2d::CCMenu*, float, cocos2d::CCPoint, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, isCorrect, , char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, loadScores, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, onDeleteLocalScores, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2eddc0, Thiscall, LevelLeaderboard, onUpdate, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, reloadLeaderboard, , LevelLeaderboardType, LevelLeaderboardMode)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelLeaderboard, setupLeaderboard, , cocos2d::CCArray*)
		}
	};
}
