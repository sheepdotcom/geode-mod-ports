...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, StarInfoPopup> : ModifyBase<ModifyDerive<Der, StarInfoPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(StarInfoPopup, createFromString, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(StarInfoPopup, createFromStringMoons, , gd::string)
