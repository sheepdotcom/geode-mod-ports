...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CheckpointGameObject> : ModifyBase<ModifyDerive<Der, CheckpointGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4a1240, Thiscall, CheckpointGameObject, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, setupCustomSprites, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, resetObject, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, customObjectSetup, , gd::vector<gd::string>&, gd::vector<void*>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, getSaveString, , GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4a12e0, Thiscall, CheckpointGameObject, triggerActivated, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, restoreObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, updateSyncedAnimation, , float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, resetCheckpoint, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CheckpointGameObject, updateCheckpointSpriteVisibility, )
		}
	};
}
