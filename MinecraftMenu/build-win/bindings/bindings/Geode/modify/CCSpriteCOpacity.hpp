...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpriteCOpacity> : ModifyBase<ModifyDerive<Der, CCSpriteCOpacity>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteCOpacity, createWithSpriteFrame, , cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CCSpriteCOpacity, createWithSpriteFrameName, , char const*)
		}
	};
}
