...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadListPopup> : ModifyBase<ModifyDerive<Der, UploadListPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadListPopup, create, , GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(UploadListPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadListPopup, show, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadListPopup, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadListPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadListPopup, onReturnToList, , cocos2d::CCObject*)
		}
	};
}
