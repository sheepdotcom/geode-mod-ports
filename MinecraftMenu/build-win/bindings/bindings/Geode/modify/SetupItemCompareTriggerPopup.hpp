...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupItemCompareTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupItemCompareTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, create, , ItemTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, valueDidChange, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, init, , ItemTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, onOpButton, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, updateFormulaLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupItemCompareTriggerPopup, updateOpButton, , CCMenuItemSpriteExtra*, int, int)
		}
	};
}
