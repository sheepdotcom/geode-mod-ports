...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardUnlockLayer> : ModifyBase<ModifyDerive<Der, RewardUnlockLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardUnlockLayer, init, , int, RewardsPage*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardUnlockLayer, playLabelEffect, , int, int, cocos2d::CCSprite*, cocos2d::CCPoint, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardUnlockLayer, playRewardEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(RewardUnlockLayer, readyToCollect, GJRewardItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(RewardUnlockLayer, showCloseButton, )
