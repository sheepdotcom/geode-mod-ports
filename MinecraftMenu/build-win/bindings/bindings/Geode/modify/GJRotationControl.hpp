...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotationControl> : ModifyBase<ModifyDerive<Der, GJRotationControl>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotationControl, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x127900, Thiscall, GJRotationControl, finishTouch, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotationControl, setAngle, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotationControl, updateSliderPosition, , cocos2d::CCPoint)
		}
	};
}
