...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRandTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupRandTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4288e0, Thiscall, SetupRandTriggerPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, onTargetID2Arrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, onTargetIDArrow, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, updateChance, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, updateChanceLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, updateTargetID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, updateTargetID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, updateTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupRandTriggerPopup, updateTextInputLabel2, )
		}
	};
}
