...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPortalPopup> : ModifyBase<ModifyDerive<Der, SetupPortalPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, onEditCameraSettings, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, onUnboundMode, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, updateCameraEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, updateCameraEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, updateCameraPadding, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, updateCameraPaddingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupPortalPopup, updateItemVisibility, )
		}
	};
}
