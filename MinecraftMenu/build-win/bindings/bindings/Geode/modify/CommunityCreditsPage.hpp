...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CommunityCreditsPage> : ModifyBase<ModifyDerive<Der, CommunityCreditsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommunityCreditsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommunityCreditsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommunityCreditsPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommunityCreditsPage, FLAlert_Clicked, , FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x96040, Thiscall, CommunityCreditsPage, goToPage, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommunityCreditsPage, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(CommunityCreditsPage, onSwitchPage, , cocos2d::CCObject*)
		}
	};
}
