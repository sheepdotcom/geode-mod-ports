...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UpdateAccountSettingsPopup> : ModifyBase<ModifyDerive<Der, UpdateAccountSettingsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UpdateAccountSettingsPopup, create, , GJAccountSettingsLayer*, int, int, int, gd::string, gd::string, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UpdateAccountSettingsPopup, init, , GJAccountSettingsLayer*, int, int, int, gd::string, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UpdateAccountSettingsPopup, onClose, , cocos2d::CCObject*)
		}
	};
}
