...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAudioTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAudioTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAudioTriggerPopup, addProxVolControls, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAudioTriggerPopup, addTimeControls, , int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAudioTriggerPopup, onProxMode, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupAudioTriggerPopup, updateSpecialGroup, )
		}
	};
}
