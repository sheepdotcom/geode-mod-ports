...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadPopup> : ModifyBase<ModifyDerive<Der, UploadPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadPopup, create, , GJGameLevel*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadPopup, init, , GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadPopup, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadPopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UploadPopup, onReturnToLevel, , cocos2d::CCObject*)
		}
	};
}
