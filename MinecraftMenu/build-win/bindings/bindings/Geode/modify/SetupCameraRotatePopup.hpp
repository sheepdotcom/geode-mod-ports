...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupCameraRotatePopup> : ModifyBase<ModifyDerive<Der, SetupCameraRotatePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, textChanged, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, valuePopupClosed, , ConfigureValuePopup*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, onEasing, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, onEasingRate, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, sliderDegreesChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, toggleEasingRateVisibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateCommandDegrees, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateDegreesLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateDurLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateEasingRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateMoveCommandEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupCameraRotatePopup, updateMoveCommandEasingRate, )
		}
	};
}
