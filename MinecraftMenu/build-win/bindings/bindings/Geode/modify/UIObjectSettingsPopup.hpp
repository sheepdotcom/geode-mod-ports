...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UIObjectSettingsPopup> : ModifyBase<ModifyDerive<Der, UIObjectSettingsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIObjectSettingsPopup, create, , UISettingsGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIObjectSettingsPopup, onCustomToggleTriggerValue, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(UIObjectSettingsPopup, init, , UISettingsGameObject*, cocos2d::CCArray*)
		}
	};
}
