...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer6> : ModifyBase<ModifyDerive<Der, SecretLayer6>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer6, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer6, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer6, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer6, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer6, onBack, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SecretLayer6, startGame01, )
		}
	};
}
