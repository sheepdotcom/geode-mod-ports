...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountRegisterLayer> : ModifyBase<ModifyDerive<Der, AccountRegisterLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, registerWithTouchDispatcher, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, createTextBackground, , cocos2d::CCPoint, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, createTextInput, , cocos2d::CCPoint, cocos2d::CCSize, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, createTextLabel, , cocos2d::CCPoint, gd::string, cocos2d::CCSize)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, disableNodes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, hideLoadingUI, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, onSubmit, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, resetLabel, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, resetLabels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, showLoadingUI, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, toggleUI, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, updateLabel, , AccountError)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, validEmail, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, validPassword, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(AccountRegisterLayer, validUser, , gd::string)
		}
	};
}
