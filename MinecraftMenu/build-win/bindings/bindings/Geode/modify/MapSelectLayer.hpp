...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MapSelectLayer> : ModifyBase<ModifyDerive<Der, MapSelectLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, scene, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, update, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, ccTouchBegan, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, ccTouchMoved, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, ccTouchEnded, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, ccTouchCancelled, , cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, scrollWheel, , float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, checkTouchMonster, , cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, createObjectAtPoint, , cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, getConstrainedMapPos, , cocos2d::CCPoint)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(MapSelectLayer, onBack, , cocos2d::CCObject*)
		}
	};
}
