...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, FollowRewardPage> : ModifyBase<ModifyDerive<Der, FollowRewardPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, show, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(FollowRewardPage, onRewardedVideo, , cocos2d::CCObject*)
