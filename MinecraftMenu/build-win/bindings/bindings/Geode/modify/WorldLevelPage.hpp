...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, WorldLevelPage> : ModifyBase<ModifyDerive<Der, WorldLevelPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, create, , GJGameLevel*, GJWorldNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, init, , GJGameLevel*, GJWorldNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, onInfo, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, onPlay, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(WorldLevelPage, onSong, , cocos2d::CCObject*)
		}
	};
}
