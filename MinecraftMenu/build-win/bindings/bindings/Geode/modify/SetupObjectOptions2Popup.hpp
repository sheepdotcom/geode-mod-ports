...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectOptions2Popup> : ModifyBase<ModifyDerive<Der, SetupObjectOptions2Popup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupObjectOptions2Popup, create, , GameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupObjectOptions2Popup, onPlusButton, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupObjectOptions2Popup, init, , GameObject*, cocos2d::CCArray*)
		}
	};
}
