...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelSettingsLayer> : ModifyBase<ModifyDerive<Der, LevelSettingsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelSettingsLayer, textInputClosed, , CCTextInputNode*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelSettingsLayer, onCol, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelSettingsLayer, onDisable, , cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(LevelSettingsLayer, onSelectFont, , cocos2d::CCObject*)
