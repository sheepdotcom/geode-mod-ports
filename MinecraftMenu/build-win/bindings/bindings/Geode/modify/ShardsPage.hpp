...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShardsPage> : ModifyBase<ModifyDerive<Der, ShardsPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ShardsPage, show, )
