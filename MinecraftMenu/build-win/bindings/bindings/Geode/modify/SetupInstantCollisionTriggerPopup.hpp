...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupInstantCollisionTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupInstantCollisionTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCollisionTriggerPopup, create, , EffectGameObject*, cocos2d::CCArray*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCollisionTriggerPopup, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SetupInstantCollisionTriggerPopup, updateSpecialNodes, )
		}
	};
}
