...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ExplodeItemNode> : ModifyBase<ModifyDerive<Der, ExplodeItemNode>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ExplodeItemNode, create, , cocos2d::CCRenderTexture*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ExplodeItemNode, update, , float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ExplodeItemNode, createSprites, , int, int, float, float, float, float, float, float, cocos2d::ccColor4F, cocos2d::ccColor4F, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(ExplodeItemNode, init, , cocos2d::CCRenderTexture*)
		}
	};
}
