...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, KeybindingsManager> : ModifyBase<ModifyDerive<Der, KeybindingsManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, sharedState, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, commandForKey, , cocos2d::enumKeyCodes, GJKeyGroup, bool, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, commandForKeyMods, , cocos2d::enumKeyCodes, GJKeyGroup)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, commandForKeyNoMods, , cocos2d::enumKeyCodes, GJKeyGroup)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, commandToKeyForGroup, , GJKeyGroup)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, dataLoaded, , DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, encodeDataTo, , DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, firstSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, groupForCommand, , GJKeyCommand)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, keyForCommand, , GJKeyCommand)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(KeybindingsManager, keyToCommandForGroup, , GJKeyGroup)
		}
	};
}
