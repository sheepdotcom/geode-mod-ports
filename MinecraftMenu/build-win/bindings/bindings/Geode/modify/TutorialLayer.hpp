...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialLayer> : ModifyBase<ModifyDerive<Der, TutorialLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialLayer, create, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialLayer, loadPage, , int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialLayer, onNext, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(TutorialLayer, removeTutorialTexture, )
		}
	};
}
