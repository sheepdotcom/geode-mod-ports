...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJRotateCommandLayer> : ModifyBase<ModifyDerive<Der, GJRotateCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, create, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, textChanged, , CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, valuePopupClosed, , ConfigureValuePopup*, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, init, , EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onEasing, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onEasingRate, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onFollowRotation, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onLockRotation, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onUpdateGroupID, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, onUpdateGroupID2, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, sliderChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, sliderDegreesChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, sliderTimesChanged, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, toggleEasingRateVisibility, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateCommandDegrees, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateCommandTimes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateDegreesLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateDurLabel, , bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateEasingLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateEasingRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateMoveCommandEasing, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateMoveCommandEasingRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateTargetGroupID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateTargetGroupID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateTextInputLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateTextInputLabel2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GJRotateCommandLayer, updateTimesLabel, )
		}
	};
}
