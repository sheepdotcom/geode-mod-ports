...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameCell> : ModifyBase<ModifyDerive<Der, GameCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3cbf0, Thiscall, GameCell, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameCell, loadFromString, , gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(GameCell, onTouch, , cocos2d::CCObject*)
