...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectPremadeLayer> : ModifyBase<ModifyDerive<Der, SelectPremadeLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectPremadeLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectPremadeLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectPremadeLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectPremadeLayer, onClose, , cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR(SelectPremadeLayer, onSelectPremade, , cocos2d::CCObject*)
		}
	};
}
