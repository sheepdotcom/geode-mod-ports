...
private:
    [[deprecated("SecretLayer5::fadeInMessage not implemented")]]
    /**
     * @note[short] Android
     */
    void fadeInMessage();
...
private:
    [[deprecated("SecretLayer5::incrementChatIdx not implemented")]]
    /**
     * @note[short] Android
     */
...
private:
    [[deprecated("SecretLayer5::showDialog not implemented")]]
    /**
     * @note[short] Android
     */
