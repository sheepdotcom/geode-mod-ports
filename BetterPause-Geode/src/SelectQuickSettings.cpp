...
bool SelectQuickSettings::setup(bool inGame)
{
	...
	this->m_bgSprite->setPosition({ m_mainLayer->getContentWidth() / 2.f, m_mainLayer->getContentHeight() / 2.f });
	...
	m_closeBtn->setPosition({ m_mainLayer->getContentWidth() / 2.f - 210.f, m_mainLayer->getContentHeight() / 2 + 140.f });
	m_buttonMenu->addChild(m_closeBtn);

	this->m_pTitleLayer = cocos2d::CCLabelBMFont::create("- Select Quick Settings -", "bigFont.fnt");
	this->m_pTitleLayer->setScale(0.7f);
	this->m_pTitleLayer->setPosition({ m_mainLayer->getContentWidth() / 2.f, m_mainLayer->getContentHeight() / 2.f + 120.f });
	m_mainLayer->addChild(this->m_pTitleLayer);

	this->m_pUnderLine = cocos2d::CCSprite::createWithSpriteFrameName("floorLine_001.png");
	this->m_pUnderLine->setPosition({ m_mainLayer->getContentWidth() / 2.f, m_mainLayer->getContentHeight() / 2.f + 100.f });
	...
	gjCommentBase->setPosition({ m_mainLayer->getContentWidth() / 2.f - 165.f, m_mainLayer->getContentHeight() / 2.f - 120.f });
