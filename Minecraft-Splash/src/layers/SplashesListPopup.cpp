    ...
    geode::createQuickPopup(
        ...
        [this, index](auto, bool btn2) {
            if(!btn2) {
                ...
                this->m_scrollLayer->m_contentLayer->getChildByID(std::to_string(index).c_str())->getChildByType<CCLabelBMFont>(0)->runAction(CCSequence::create(
                    CCFadeOut::create(0.4),
                    nullptr
                ));
                auto menu = this->m_scrollLayer->m_contentLayer->getChildByID(std::to_string(index).c_str())->getChildByType<CCMenu>(0);
                ...
                for(size_t i = index + 1; i < size; i++) {
                    auto node = static_cast<CCNode*>(this->m_scrollLayer->m_contentLayer->getChildByID(std::to_string(i).c_str()));
                    static_cast<CCMenuItemSpriteExtra*>(node->getChildByType<CCMenu>(0)->getChildren()->objectAtIndex(0))->setID(std::to_string(std::stoi(static_cast<CCMenuItemSpriteExtra*>(node->getChildByType<CCMenu>(0)->getChildren()->objectAtIndex(0))->getID()) - 1).c_str());
                    static_cast<CCMenuItemSpriteExtra*>(node->getChildByType<CCMenu>(0)->getChildren()->objectAtIndex(1))->setID(std::to_string(std::stoi(static_cast<CCMenuItemSpriteExtra*>(node->getChildByType<CCMenu>(0)->getChildren()->objectAtIndex(1))->getID()) - 1).c_str());
